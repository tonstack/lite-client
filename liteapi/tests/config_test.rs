    ...
    let config_json = r#"
{
  ...
  "dht": {
    ...
    "static_nodes": {
      ...
      "nodes": [
          ...
          "id":{
             "@type":"pub.ed25519",
             "key": "NutLY+VWoaLqgpNCdOR8Jp+Cf2gnDjToza9d+qUnHyE="
          },
          "addr_list":{
          ...
          "version":-1,
            "signature": "Pb7fVqjtgvnqdTHtfJmTzvaZ7gZpkDeKThrRYTXmlpiDtPcCjijQW+m6Zg5V9ZGt2hVljnLbfvC48K4iYqzRBQ=="
       },
       {
          "@type":"dht.node",
          "id":{
             "@type":"pub.ed25519",
             "key":"Tr5TtwdWtLH53F/aOm0eUiwNEOlS7A+AV24wNI7uD9I="
          },
          "addr_list":{
             "@type":"adnl.addressList",
             "addrs":[
          ...
          "version":-1,
          "signature":"W6R7JLsLHaGKN6xnLbqydm8vVb+q/MqYmOwZvTWHx7EPOq7Y2eO4J0kf+4VVuQ5juLbZyATN5/gCbR6NPkvlDQ=="
       },
       {
          "@type":"dht.node",
          "id":{
       ...
       },
       {
          ...
          "id":{
             "@type":"pub.ed25519",
             "key":"39QMN3uUgYxgu67GxapW+T3YAM8N+pU4/AmwM89aH9E="
          },
          "addr_list":{
             "@type":"adnl.addressList",
             "addrs":[
          ...
          "version":-1,
          "signature":"/mSDe4QY5JAmG4WOQDCN3pKHYkGxOZ8g74fYbqDJ2e2UDg38+s1ecC3+n6RfU74sz0KUNYlcHAopu6VrWA7PAg=="
       },
       {
          "@type":"dht.node",
          "id":{
  ...
  "validator": {
    ...
    let v: ConfigGlobal = serde_json::from_str(config_json).unwrap();
    println!("{:?}", v);
}
