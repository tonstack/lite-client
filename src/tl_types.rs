...
#[tl(
    boxed,
    id = "liteServer.error",
    scheme_inline = r##"liteServer.error code:int message:string = liteServer.Error; "##
)]
pub struct Error {
    pub code: i32,
...
#[tl(
    ...
    scheme_inline = r##"liteServer.masterchainInfo last:tonNode.blockIdExt state_root_hash:int256 init:tonNode.zeroStateIdExt = liteServer.MasterchainInfo;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.masterchainInfoExt mode:# version:int capabilities:long last:tonNode.blockIdExt last_utime:int now:int state_root_hash:int256 init:tonNode.zeroStateIdExt = liteServer.MasterchainInfoExt;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.currentTime now:int = liteServer.CurrentTime;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.version",
    scheme_inline = r##"liteServer.version mode:# version:int capabilities:long now:int = liteServer.Version;"##
)]
pub struct Version {
    pub mode: i32,
    pub version: i32,
...
#[tl(
    boxed,
    id = "liteServer.blockData",
    scheme_inline = r##"liteServer.blockData id:tonNode.blockIdExt data:bytes = liteServer.BlockData;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.blockState",
    scheme_inline = r##"liteServer.blockState id:tonNode.blockIdExt root_hash:int256 file_hash:int256 data:bytes = liteServer.BlockState;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.blockHeader",
    scheme_inline = r##"liteServer.blockHeader id:tonNode.blockIdExt mode:# header_proof:bytes = liteServer.BlockHeader;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.sendMsgStatus",
    scheme_inline = r##"liteServer.sendMsgStatus status:int = liteServer.SendMsgStatus;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.accountState",
    scheme_inline = r##"liteServer.accountState id:tonNode.blockIdExt shardblk:tonNode.blockIdExt shard_proof:bytes proof:bytes state:bytes = liteServer.AccountState;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.runMethodResult",
    scheme_inline = r##"liteServer.runMethodResult mode:# id:tonNode.blockIdExt shardblk:tonNode.blockIdExt shard_proof:mode.0?bytes proof:mode.0?bytes state_proof:mode.1?bytes init_c7:mode.3?bytes lib_extras:mode.4?bytes exit_code:int result:mode.2?bytes = liteServer.RunMethodResult;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.shardInfo",
    scheme_inline = r##"liteServer.shardInfo id:tonNode.blockIdExt shardblk:tonNode.blockIdExt shard_proof:bytes shard_descr:bytes = liteServer.ShardInfo;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.allShardsInfo id:tonNode.blockIdExt proof:bytes data:bytes = liteServer.AllShardsInfo;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.transactionList",
    scheme_inline = r##"liteServer.transactionList ids:(vector tonNode.blockIdExt) transactions:bytes = liteServer.TransactionList;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.blockTransactions",
    scheme_inline = r##"liteServer.blockTransactions id:tonNode.blockIdExt req_count:# incomplete:Bool ids:(vector liteServer.transactionId) proof:bytes = liteServer.BlockTransactions;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.partialBlockProof",
    scheme_inline = r##"liteServer.partialBlockProof complete:Bool from:tonNode.blockIdExt to:tonNode.blockIdExt steps:(vector liteServer.BlockLink) = liteServer.PartialBlockProof;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.configInfo",
    scheme_inline = r##"liteServer.configInfo mode:# id:tonNode.blockIdExt state_proof:bytes config_proof:bytes = liteServer.ConfigInfo;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.validatorStats",
    scheme_inline = r##"liteServer.validatorStats mode:# id:tonNode.blockIdExt count:int complete:Bool state_proof:bytes data_proof:bytes = liteServer.ValidatorStats;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.debug.verbosity",
    scheme_inline = r##"liteServer.debug.verbosity value:int = liteServer.debug.Verbosity;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.getMasterchainInfo = liteServer.MasterchainInfo;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.getMasterchainInfoExt mode:# = liteServer.MasterchainInfoExt;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.getTime = liteServer.CurrentTime;"##
)]
pub struct GetTime;
...
#[tl(
    boxed,
    id = "liteServer.getVersion",
    scheme_inline = r##"liteServer.getVersion = liteServer.Version;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getBlock",
    scheme_inline = r##"liteServer.getBlock id:tonNode.blockIdExt = liteServer.BlockData;"##
)]
pub struct GetBlock {
    pub id: BlockIdExt,
}
...
#[tl(
    boxed,
    id = "liteServer.getState",
    scheme_inline = r##"liteServer.getState id:tonNode.blockIdExt = liteServer.BlockState;"##
)]
pub struct GetState {
    pub id: BlockIdExt,
}
...
#[tl(
    boxed,
    id = "liteServer.getBlockHeader",
    scheme_inline = r##"liteServer.getBlockHeader id:tonNode.blockIdExt mode:# = liteServer.BlockHeader;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.sendMessage",
    scheme_inline = r##"liteServer.sendMessage body:bytes = liteServer.SendMsgStatus;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.getAccountState id:tonNode.blockIdExt account:liteServer.accountId = liteServer.AccountState;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.runSmcMethod",
    scheme_inline = r##"liteServer.runSmcMethod mode:# id:tonNode.blockIdExt account:liteServer.accountId method_id:long params:bytes = liteServer.RunMethodResult;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getShardInfo",
    scheme_inline = r##"liteServer.getShardInfo id:tonNode.blockIdExt workchain:int shard:long exact:Bool = liteServer.ShardInfo;"##
)]
...
#[tl(
    ...
    scheme_inline = r##"liteServer.getAllShardsInfo id:tonNode.blockIdExt = liteServer.AllShardsInfo;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getOneTransaction",
    scheme_inline = r##"liteServer.getOneTransaction id:tonNode.blockIdExt account:liteServer.accountId lt:long = liteServer.TransactionInfo;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getTransactions",
    scheme_inline = r##"liteServer.getTransactions count:# account:liteServer.accountId lt:long hash:int256 = liteServer.TransactionList;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.lookupBlock",
    scheme_inline = r##"liteServer.lookupBlock mode:# id:tonNode.blockId lt:mode.1?long utime:mode.2?int = liteServer.BlockHeader;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.listBlockTransactions",
    scheme_inline = r##"liteServer.listBlockTransactions id:tonNode.blockIdExt mode:# count:# after:mode.7?liteServer.transactionId3 reverse_order:mode.6?true want_proof:mode.5?true = liteServer.BlockTransactions;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getBlockProof",
    scheme_inline = r##"liteServer.getBlockProof mode:# known_block:tonNode.blockIdExt target_block:mode.0?tonNode.blockIdExt = liteServer.PartialBlockProof;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getConfigAll",
    scheme_inline = r##"liteServer.getConfigAll mode:# id:tonNode.blockIdExt = liteServer.ConfigInfo;"##
)]
...
#[tl(
    boxed,
    id = "liteServer.getConfigParams",
    scheme_inline = r##"liteServer.getConfigParams mode:# id:tonNode.blockIdExt param_list:(vector int) = liteServer.ConfigInfo;"##
)]
...
mod tests {
    ...
    #[test]
    fn block_id_test() {
        let bytes = tl_proto::serialize(&BlockId {
            workchain: 0,
    ...
    fn int256_test() {
        ...
        let _check: [u8; 32] = [
            ...
            98, 123, 220, 93, 248, 39, 201, 131, 164, 150, 92, 174,
        ];
